...
| 4       |  Servers (Various Types)                                                              | Configure and manage different types of servers                                           | - Study and configure various server types (web, FTP, DHCP, SMB, SMTP, IMAP, POP3)                                                                                                                                                                                                           | Pradyun, Hari |
...
|Session|Topics|End Goals|Tasks|Person|
|---|---|---|---|---|
|1|Active Directory (AD)|Understand and configure Active Directory|- Study AD concepts<br>- Configure AD in a Windows environment|Pradyun, Manoj|
